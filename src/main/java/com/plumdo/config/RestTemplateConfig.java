...
public class RestTemplateConfig {
	...
	public RestTemplate restTemplate(ClientHttpRequestFactory factory) {
		...
		// 使用 utf-8 编码集的 conver 替换默认的 conver（默认的 string conver的编码集为"ISO-8859-1"）
		...
		messageConverters.add(new StringHttpMessageConverter(Charset.forName(ConfigConstant.DEFAULT_CHARSET)));
		return restTemplate;
	}
