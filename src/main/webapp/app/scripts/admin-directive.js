...
(function() {
  ...
  angular.module('stockApp').directive('mdDatetimeRange', 
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        element.removeAttr('md-datetime-range');
        ...
        element.attr('dt-type','datetime-range')
        element.attr('dt-q-select', 'qSelectRange');
        ...
        function transformTable() {
          ...
          $timeout(function () {
            ...
            angular.element(elem.querySelectorAll('tbody')).css({
                'display': 'block',
                'height': $attrs.tableHeight||($window.innerHeight-482>200?$window.innerHeight-482:200),
                'overflow': 'auto'
            });

            angular.element(window).bind('resize', function () {
            	angular.element(elem.querySelectorAll('tbody')).css({'height': $attrs.tableHeight||($window.innerHeight-482>200?$window.innerHeight-482:200)});
            });
